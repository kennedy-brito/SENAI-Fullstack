...
public class HomeController : Controller
{
    ...
    {
        var cliente1 = new Cliente(01, "Arthur A. Ferreira", "857.032.950 - 41", "arthur.antunes@sp.senai.br", "Madruga");
        var cliente2 = new Cliente(02, "William Henry Gates III", "039.618.250 - 09", "bill@microsoft.com", "Bug");
        var cliente3 = new Cliente(03, "Ada Lovelace", "800.777.920-50", "ada@ada.language.com", "Byron");
        var cliente4 = new Cliente(04, "Linus Torvalds", "933.622.400 - 03", "torvalds@osdl.org", "Pinguim");
        var cliente5 = new Cliente(05, "Grace Hopper", "911.702.988-00", "grace.hopper@cobol.com", "Loboc");
